...
from opencood.utils import v2_box_utils as box_utils
from opencood.data_utils.datasets import v2_basedataset
...
class V2IntermediateFusionDataset(v2_basedataset.BaseDataset):
    def __init__(self, params, visualize, train=True, isSim=False):
        super(V2IntermediateFusionDataset, self). \
