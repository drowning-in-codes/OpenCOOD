...
from opencood.data_utils.datasets.v2_basedataset import BaseDataset
...
from opencood.utils.v2_transformation_utils import x1_to_x2


class V2EarlyFusionDataset(BaseDataset):
    def __init__(self, params, visualize, train=True, isSim=False):
        super(V2EarlyFusionDataset, self).__init__(params, visualize, train, isSim)
