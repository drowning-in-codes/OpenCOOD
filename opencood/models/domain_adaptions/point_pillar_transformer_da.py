...
from opencood.models.point_pillar_transformer import (
    PointPillarTransformer as PointPillarTransformerVBase,
)


class PointPillarTransformerDA(PointPillarTransformerVBase):
    ...
    def forward(self, data_dict):
        ...
        for data_per in data_dict:
            ...
            regroup_feature, mask = regroup(
                spatial_features_2d, record_len, self.max_cav
            )
