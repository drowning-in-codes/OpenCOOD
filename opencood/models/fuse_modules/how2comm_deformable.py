...
from opencood.models.communication_modules.communication import Communication
from opencood.models.sub_modules.how2comm_preprocess import How2commPreprocess
from opencood.models.fuse_modules.stcformer import STCFormer
        ...
        if self.multi_scale:
            ...
            for i in range(self.num_levels):
                ...
                for b in range(B):
                    ...
                    if self.agg_mode == "STCFormer":
                        fusion, output_list = self.fuse_modules[i](neighbor_feature, neighbor_psm_list[b],
                                                                   neighbor_feature_his, i)
