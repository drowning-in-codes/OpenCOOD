...
# )
# from opencood.data_utils.datasets.v2_intermediate_fusion_dataset import (
#     IntermediateFusionDataset as V2IntermediateFusionDataset,
# )
...
#     "v2_intermediate_fusion": V2IntermediateFusionDataset,
# }
...
from opencood.data_utils.datasets.v2_intermediate_fusion_dataset import (
    V2IntermediateFusionDataset,
)

from opencood.data_utils.datasets.v2_early_fusion_dataset import V2EarlyFusionDataset
...
__all__ = {
    ...
    "IntermediateFusionDataset": IntermediateFusionDataset,
    "v2_intermediate_fusion": V2IntermediateFusionDataset,
    "V2EarlyFusionDataset": V2EarlyFusionDataset,
}

# the final range for evaluation
GT_RANGE = [-100, -40, -5, 100, 40, 3]  #! for v2v4real
# The communication range for cavs
COM_RANGE = 70
...
def build_dataset(dataset_cfg, visualize=False, train=True, isSim=False):
    ...
    dataset = __all__[dataset_name](
        params=dataset_cfg, visualize=visualize, train=train, isSim=isSim
    )
