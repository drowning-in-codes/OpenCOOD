...
def test_parser():
    ...
    parser.add_argument('--save_start', type=int, required=False, default=1500,
...
def main():
    ...
    for i, batch_data in tqdm(enumerate(data_loader, start=start_index)):
        ...
        with torch.no_grad():
            ...
            simple_vis.ori_visualize(pred_box_tensor,
                                 gt_box_tensor,
                                 batch_data['ego'][
    ...
    if len(total_comm_rates) > 0:
        ...
        comm_rates = 0
    ap_30, ap_50, ap_70 = eval_utils.eval_final_results(result_stat, opt.model_dir, global_sort_detections=False)
